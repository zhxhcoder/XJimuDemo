...
/**
 * Created by zhxh on 2018/10/29
 */
public class LoadingDialog extends Dialog {

    public LoadingDialog(Context context) {
        this(context, R.style.common_TipDialog);
    }
    ...
    public static class Builder {
        ...
        public LoadingDialog create() {
            ...
            dialog.setContentView(R.layout.common_tip_dialog_layout);
            ViewGroup contentWrap = (ViewGroup) dialog.findViewById(R.id.contentWrap);

            if (mCurrentIconType == ICON_TYPE_SUCCESS || mCurrentIconType == ICON_TYPE_FAIL || mCurrentIconType == ICON_TYPE_INFO) {
                ...
                if (mCurrentIconType == ICON_TYPE_SUCCESS) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ngw_icon_notify_done));
                } else if (mCurrentIconType == ICON_TYPE_FAIL) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ngw_icon_notify_error));
                } else {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ngw_icon_notify_info));
                }
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                tipView.setTextColor(ContextCompat.getColor(mContext, R.color.common_color_white));
